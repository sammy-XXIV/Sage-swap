import { StonApiClient, StonApiClientOptions } from './client/apiClient';
...
export type AssetInfoV2 = Awaited<ReturnType<StonApiClient["queryAssets"]>>[number];
...
export type SwapPair = Awaited<ReturnType<StonApiClient["getSwapPairs"]>>[number];
export type OperationInfo = Awaited<ReturnType<StonApiClient["getOperations"]>>[number];
export type RouterInfo = Awaited<ReturnType<StonApiClient["getRouters"]>>[number];
