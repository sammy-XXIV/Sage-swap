import { AssetInfoResponse } from './asset';

export declare const OperationType: {
    readonly Swap: "swap";
    readonly SendLiquidity: "send_liquidity";
    readonly RefundLiquidity: "refund_liquidity";
    readonly AddLiquidity: "add_liquidity";
    readonly WithdrawLiquidity: "withdraw_liquidity";
    readonly SetFees: "set_fees";
    readonly CollectFees: "collect_fees";
    readonly ResetGas: "reset_gas";
};
