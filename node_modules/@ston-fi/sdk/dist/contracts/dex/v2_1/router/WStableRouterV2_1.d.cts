...
import { WStablePoolV2_1 } from '../pool/WStablePoolV2_1.cjs';
...
declare class WStableRouterV2_1 extends BaseRouterV2_1 {
    static readonly dexType: "weighted_stableswap";
    ...
    getPool(provider: ContractProvider, params: {
        token0: AddressType;
        token1: AddressType;
    }): Promise<WStablePoolV2_1>;
}

export { WStableRouterV2_1 };
