import { Address, ContractProvider, Cell, SenderArguments } from '@ton/ton';
import { AmountType, AddressType, QueryIdType } from '../../types.js';
import { pTON_VERSION } from './constants.js';

interface AbstractPton {
