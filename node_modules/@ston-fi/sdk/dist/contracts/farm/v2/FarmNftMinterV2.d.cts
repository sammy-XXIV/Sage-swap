...
import { FarmNftMinterV1, FarmNftMinterV1Options } from '../v1/FarmNftMinterV1.cjs';
import '../../../types.cjs';
import '../../core/Contract.cjs';
import '../constants.cjs';

interface FarmNftMinterV2Options extends FarmNftMinterV1Options {
}
/**
 ...
 */
declare class FarmNftMinterV2 extends FarmNftMinterV1 {
    static version: "v2";
    /**
    ...
    getPendingData(provider: ContractProvider): Promise<{
        ...
        newCustodian: _ton_ton.Address | null;
        pendingMsg: _ton_ton.Cell;
        newCode: _ton_ton.Cell;
        newStorage: _ton_ton.Cell;
    }>;
    /**
    ...
    getFarmingMinterData(provider: ContractProvider): Promise<{
        ...
        adminFee: bigint;
        minStakeTime: bigint;
        stakingTokenWallet: _ton_ton.Address;
        rewardTokenWallet: _ton_ton.Address;
        custodianAddress: _ton_ton.Address | null;
...
export { FarmNftMinterV2, type FarmNftMinterV2Options };
